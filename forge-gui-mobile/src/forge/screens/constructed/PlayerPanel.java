...
public class PlayerPanel extends FContainer {
    ...
    private final FDeckChooser deckChooser, lstSchemeDecks, lstCommanderDecks, lstOathbreakerDecks, lstTinyLeadersDecks, lstBrawlDecks, lstDuelCommanderDecks, lstPlanarDecks;
    ...
    public void initialize(FPref savedStateSetting, FPref savedStateSettingCommander, FPref savedStateSettingOathbreaker, FPref savedStateSettingTinyLeader, FPref savedStateSettingBrawl, FPref savedStateSettingDuelCommander, DeckType defaultDeckType) {
    ...
    public float getPreferredHeight() {
        ...
        if (btnCommanderDeck.isVisible() || btnOathbreakDeck.isVisible() || btnTinyLeadersDeck.isVisible() || btnBrawlDeck.isVisible() || btnDuelCommanderDeck.isVisible()) {
            if(Forge.isLandscapeMode())
                rows++;
        }
        if (btnSchemeDeck.isVisible()) {
    ...
    public Deck getBrawlDeck() { return lstBrawlDecks.getDeck(); }

    public Deck getDuelCommanderDeck() { return lstDuelCommanderDecks.getDeck(); }
