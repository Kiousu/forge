...
public final class FModel {
    ...
    public static void initialize(final IProgressBar progressBar, Function<ForgePreferences, Void> adjustPrefs, boolean isSimTest) {
        ...
        getMagicDb().setTinyLeadersPredicate(getFormats().get("Tiny Leaders").getFilterRules());
        getMagicDb().setTinyLeadersAllowedAsCommanderPredicate(getFormats().get("Tiny Leaders").getFilterAllowedAsCommander());
        getMagicDb().setDuelCommanderPredicate(getFormats().get("Duel Commander").getFilterRules());
        getMagicDb().setDuelCommanderAllowedAsCommanderPredicate(getFormats().get("Duel Commander").getFilterAllowedAsCommander());
